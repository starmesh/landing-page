...
export default class Tech extends Vue { 
  private text = {
    ...
    second: [
      '<h3>Filecoin</h3>',
      '<b>Reliably store files at hyper­competitive prices</b>.',
